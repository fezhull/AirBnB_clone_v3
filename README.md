...
* Update the method `to_dict()` of `BaseModel` to remove the `password` key __except when it’s used by `FileStorage` to save data to disk__. Tips: default parameters
